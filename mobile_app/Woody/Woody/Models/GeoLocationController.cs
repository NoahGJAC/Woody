...
{
    /// <summary>
    /// Represents a geolocation controller that manages sensors and actuators.
    /// </summary>
    public class GeoLocationController : INotifyPropertyChanged, IController
    {
        /// <summary>
        /// Gets the list of sensors managed by the geolocation controller.
        /// </summary>
        public List<ISensor> Sensors { get; private set; }

        /// <summary>
        /// Gets the list of actuators managed by the geolocation controller.
        /// </summary>
