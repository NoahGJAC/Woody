from python.controllers import (
    IDeviceController,
...
from python.actuators.plant.light import LightState
...
class Farm:
    ...
    def __init__(self, subsystems: list[IDeviceController]) -> None:
        ...
        self.led = LightController(
                gpio=12, command_type=ACommand.Type.LIGHT_ON_OFF, reading_type=AReading.Type.LED, initial_state=LightState.OFF
            )
    ...
    async def loop(self) -> None:
        ...
        self._connection_manager.register_command_callback(self.command_callback)
...
async def farm_main():
    ...
    subsystems = [
        ...
        #         ),
        #         LoudnessSensor(
        #             gpio=0, model="Grove - Loudness Sensor", type=AReading.Type.LOUDNESS
        #         ),
        #         LuminositySensor(
        #             gpio=None,
